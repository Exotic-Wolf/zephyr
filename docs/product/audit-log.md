...
|---|---|---|---|---|
| Closed/internal testing readiness | A- | Root `pnpm check` passed on 13 Jun 2026; fresh local AAB `1.0.26+27` exists and release manifest confirms version code `27` with the onboarding overflow and presence listener recovery fixes | Upload/test `1.0.26+27`, then complete manual launch-minimum smoke | `current-state.md` |
