...
4. Upload Android AAB `1.0.21+22` to Play/internal testing or use a newer store-accepted build, then run launch-minimum device smoke. Current local AAB candidate: `apps/zephyr-mobile/build/app/outputs/bundle/release/app-release.aab`, package `com.zephyr.zephyr_mobile`, SHA-256 `555344584eccc27f3eafebb5824f95ac4c400ea1500bea90a7e4bb1ad7c6f099`.
