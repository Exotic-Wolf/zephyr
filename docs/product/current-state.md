...
| P1 | In progress | Codex | Expand reusable Gift module beyond live | Backend reusable gift catalog/send contract, Admin-owned inbox gift card projection, and Inbox picker/card/animation UI exist; manual smoke and live/call/random/premium migration remain |
...
10. Manually smoke Inbox gifts with two accounts, then migrate live/call/random/premium surfaces off the legacy tray and onto the reusable gift module.
11. Implement premium live lifecycle, paid entry, lock screen, metered billing, and `PremiumLiveRealtime`.

## Current Solution Snapshot (12 Jun 2026)
